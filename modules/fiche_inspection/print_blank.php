...
<body>
    ...
    <div class="observations-lines" style="margin-top: 5px;">
        <div style="border-bottom: 1px dotted #000; min-height: 20px;"></div>
        <div style="border-bottom: 1px dotted #000; min-height: 20px;"></div>
        <div style="border-bottom: 1px dotted #000; min-height: 20px;"></div>
    </div>
    ...
    <div class="observations-lines" style="margin-top: 10px;">
        <?php for ($i = 0; $i < 12; $i++): ?>
    ...
    <div class="signature-section">
        <div class="signature-box">
            ...
            <div style="margin-top: 80px; border-top: 1px solid #000; display: inline-block; padding-top: 5px;">
                Signature et cachet
            </div>
        </div>
