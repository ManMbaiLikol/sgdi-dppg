-- Installation du système de permissions granulaires
-- À exécuter dans phpMyAdmin ou en ligne de commande

-- IMPORTANT : Vérifier le nom de votre base de données
-- Utiliser sgdi_mvp OU sgdi_db selon votre configuration
USE sgdi_mvp;
