-- Schéma de permissions granulaires pour SGDI
-- Permet d'affecter des permissions spécifiques à chaque utilisateur
...
-- Module Dossiers
INSERT INTO permissions (code, module, nom, description) VALUES
