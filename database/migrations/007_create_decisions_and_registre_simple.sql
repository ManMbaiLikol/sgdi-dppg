...
-- Version simplifiée SANS clés étrangères
...
COMMENT='Décisions ministérielles finales pour les dossiers d implantation';
...
CREATE TABLE IF NOT EXISTS registre_public (
    ...
    date_publication DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT='Date de publication automatique au registre public',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
COMMENT='Registre public des infrastructures approuvées - accessible sans authentification';
