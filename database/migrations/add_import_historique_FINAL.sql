-- Migration FINALE pour le module import historique
-- Compatible MyISAM (sans clés étrangères)
...
-- ÉTAPE 2 : Créer la table entreprises_beneficiaires (SANS clé étrangère)
...
-- ÉTAPE 3 : Créer la table logs_import_historique (SANS clé étrangère)
...
SELECT
    ...
    d.source_import,
    d.statut,
    CONCAT(u.nom, ' ', COALESCE(u.prenom, '')) as importe_par_nom,
    d.date_creation
FROM dossiers d
